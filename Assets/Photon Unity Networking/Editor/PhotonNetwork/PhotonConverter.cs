...
public class PhotonConverter : Photon.MonoBehaviour
{
    public static void RunConversion()
    {
        ...
        EditorUtility.DisplayDialog("Completed the conversion", "Don't forget to add \"PhotonNetwork.ConnectWithDefaultSettings();\" to connect to the Photon server before using any multINWPlayer functionality.", "OK");
    }
